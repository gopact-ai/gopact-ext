...
| `devagent/workspace` | Adapt a local repository into self-bootstrap diff, file snapshot, command, and CI gate evidence. | `go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.0` |
...
Submodule tags include the module path prefix, for example `models/openai/v0.5.23`.
