...
| `devagent/workspace` | 将本地仓库适配为 self-bootstrap 的 diff、file snapshot、command 和 CI gate evidence。 | `go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.0` |
