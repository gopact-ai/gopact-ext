...
func TestAgnesProviderUsesCurrentOpenAIExtension(t *testing.T) {
	...
	const currentOpenAIExtension = "github.com/gopact-ai/gopact-ext/models/openai v0.5.24"
...
func TestRepositoryDocumentsCurrentExtensionTags(t *testing.T) {
	...
	for _, requirement := range []string{
		...
		"github.com/gopact-ai/gopact-ext/agents/humanreview v0.1.1",
		"github.com/gopact-ai/gopact-ext/agents/planexec v0.2.24",
		"github.com/gopact-ai/gopact-ext/agents/react v0.2.22",
		"github.com/gopact-ai/gopact-ext/agents/supervisor v0.1.10",
		"github.com/gopact-ai/gopact-ext/models/agnes v0.1.25",
	} {
	...
	for _, install := range []string{
		"go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.4",
		"go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.23",
		"go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.1",
		"go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.24",
		"go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.22",
		"go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.1",
		"go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.10",
		"go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.21",
		"go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.21",
		"go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.2",
		"go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.3",
		"go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.24",
		"go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.22",
		"go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.25",
	} {
...
func TestModuleReadmesDocumentCurrentExtensionTags(t *testing.T) {
	for path, install := range map[string]string{
		"agents/agentnode/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.4",
		"agents/agenttool/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.23",
		"agents/humanreview/README.md":     "go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.1",
		"agents/planexec/README.md":        "go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.24",
		"agents/react/README.md":           "go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.22",
		"agents/scheduler/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.1",
		"agents/supervisor/README.md":      "go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.10",
		"devagent/filesnapshot/README.md":  "go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.21",
		"devagent/gitdiff/README.md":       "go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.21",
		"devagent/selfbootstrap/README.md": "go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.2",
		"devagent/workspace/README.md":     "go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.3",
		"models/agnes/README.md":           "go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.25",
		"models/ark/README.md":             "go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.22",
		"models/openai/README.md":          "go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.24",
	} {
