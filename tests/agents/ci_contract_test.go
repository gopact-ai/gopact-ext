...
func TestAgnesProviderUsesCurrentOpenAIExtension(t *testing.T) {
	...
	const currentOpenAIExtension = "github.com/gopact-ai/gopact-ext/models/openai v0.5.26"
...
func TestRepositoryDocumentsCurrentExtensionTags(t *testing.T) {
	...
	for _, install := range []string{
		"go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.6",
		"go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.25",
		"go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.3",
		"go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.26",
		"go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.24",
		"go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.3",
		"go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.12",
		"go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.23",
		"go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.23",
		"go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.4",
		"go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.5",
		"go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.26",
		"go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.24",
		"go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.27",
	} {
...
func TestModuleReadmesDocumentCurrentExtensionTags(t *testing.T) {
	for path, install := range map[string]string{
		"agents/agentnode/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.6",
		"agents/agenttool/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.25",
		"agents/humanreview/README.md":     "go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.3",
		"agents/planexec/README.md":        "go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.26",
		"agents/react/README.md":           "go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.24",
		"agents/scheduler/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.3",
		"agents/supervisor/README.md":      "go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.12",
		"devagent/filesnapshot/README.md":  "go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.23",
		"devagent/gitdiff/README.md":       "go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.23",
		"devagent/selfbootstrap/README.md": "go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.4",
		"devagent/workspace/README.md":     "go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.5",
		"models/agnes/README.md":           "go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.27",
		"models/ark/README.md":             "go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.24",
		"models/openai/README.md":          "go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.26",
	} {
