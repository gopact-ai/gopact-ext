...
func TestRepositoryModulesUseCurrentCoreSDK(t *testing.T) {
	const currentCoreSDK = "github.com/gopact-ai/gopact v0.0.57"
...
func TestAgnesProviderUsesCurrentOpenAIExtension(t *testing.T) {
	...
	const currentOpenAIExtension = "github.com/gopact-ai/gopact-ext/models/openai v0.5.33"
...
func TestRepositoryDocumentsCurrentExtensionTags(t *testing.T) {
	...
	for _, install := range []string{
		"go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.13",
		"go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.32",
		"go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.10",
		"go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.3.1",
		"go get github.com/gopact-ai/gopact-ext/agents/react@v0.3.1",
		"go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.10",
		"go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.2.1",
		"go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.30",
		"go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.30",
		"go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.11",
		"go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.12",
		"go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.33",
		"go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.31",
		"go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.34",
...
func TestModuleReadmesDocumentCurrentExtensionTags(t *testing.T) {
	for path, install := range map[string]string{
		"agents/agentnode/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.13",
		"agents/agenttool/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.32",
		"agents/humanreview/README.md":     "go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.10",
		"agents/planexec/README.md":        "go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.3.1",
		"agents/react/README.md":           "go get github.com/gopact-ai/gopact-ext/agents/react@v0.3.1",
		"agents/scheduler/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.10",
		"agents/supervisor/README.md":      "go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.2.1",
		"devagent/filesnapshot/README.md":  "go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.30",
		"devagent/gitdiff/README.md":       "go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.30",
		"devagent/selfbootstrap/README.md": "go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.11",
		"devagent/workspace/README.md":     "go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.12",
		"models/agnes/README.md":           "go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.34",
		"models/ark/README.md":             "go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.31",
		"models/glm/README.md":             "go get github.com/gopact-ai/gopact-ext/models/glm@v0.1.1",
		"models/openai/README.md":          "go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.33",
	} {
