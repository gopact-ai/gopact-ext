...
func TestSelfBootstrapMockSuiteIsExecutableAndUsedByCI(t *testing.T) {
	workflow := readRepoText(t, "../../.github/workflows/ci.yml")
	readme := readRepoText(t, "../../README.md")
	readmeZH := readRepoText(t, "../../README_zh.md")
	scriptPath := "../../scripts/self-bootstrap-mock-suite.sh"
	script := readRepoText(t, scriptPath)
...
func TestRepositoryModulesUseCurrentCoreSDK(t *testing.T) {
	const currentCoreSDK = "github.com/gopact-ai/gopact v0.0.49"
...
func TestAgnesProviderUsesCurrentOpenAIExtension(t *testing.T) {
	...
	const currentOpenAIExtension = "github.com/gopact-ai/gopact-ext/models/openai v0.5.25"
...
func TestRepositoryDocumentsCurrentExtensionTags(t *testing.T) {
	...
	for _, requirement := range []string{
		"github.com/gopact-ai/gopact-ext/agents/agentnode v0.1.5",
		"github.com/gopact-ai/gopact-ext/agents/agenttool v0.1.24",
		"github.com/gopact-ai/gopact-ext/agents/humanreview v0.1.2",
		"github.com/gopact-ai/gopact-ext/agents/planexec v0.2.25",
		"github.com/gopact-ai/gopact-ext/agents/react v0.2.23",
		"github.com/gopact-ai/gopact-ext/agents/supervisor v0.1.11",
		"github.com/gopact-ai/gopact-ext/models/agnes v0.1.26",
	} {
	...
	for _, install := range []string{
		"go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.5",
		"go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.24",
		"go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.2",
		"go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.25",
		"go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.23",
		"go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.2",
		"go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.11",
		"go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.22",
		"go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.22",
		"go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.3",
		"go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.4",
		"go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.25",
		"go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.23",
		"go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.26",
	} {
...
func TestModuleReadmesDocumentCurrentExtensionTags(t *testing.T) {
	for path, install := range map[string]string{
		"agents/agentnode/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agentnode@v0.1.5",
		"agents/agenttool/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/agenttool@v0.1.24",
		"agents/humanreview/README.md":     "go get github.com/gopact-ai/gopact-ext/agents/humanreview@v0.1.2",
		"agents/planexec/README.md":        "go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.25",
		"agents/react/README.md":           "go get github.com/gopact-ai/gopact-ext/agents/react@v0.2.23",
		"agents/scheduler/README.md":       "go get github.com/gopact-ai/gopact-ext/agents/scheduler@v0.1.2",
		"agents/supervisor/README.md":      "go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.11",
		"devagent/filesnapshot/README.md":  "go get github.com/gopact-ai/gopact-ext/devagent/filesnapshot@v0.1.22",
		"devagent/gitdiff/README.md":       "go get github.com/gopact-ai/gopact-ext/devagent/gitdiff@v0.1.22",
		"devagent/selfbootstrap/README.md": "go get github.com/gopact-ai/gopact-ext/devagent/selfbootstrap@v0.1.3",
		"devagent/workspace/README.md":     "go get github.com/gopact-ai/gopact-ext/devagent/workspace@v0.1.4",
		"models/agnes/README.md":           "go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.26",
		"models/ark/README.md":             "go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.23",
		"models/openai/README.md":          "go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.25",
	} {
