...
Install it with `go get github.com/gopact-ai/gopact-ext/models/ark@v0.2.19`. If an Ark endpoint is being used as an OpenAI-compatible HTTP API, use `models/openai` instead; this module is for the Ark SDK path.
