...
Install it with `go get github.com/gopact-ai/gopact-ext/models/agnes@v0.1.28`. Use `New` for the default Agnes endpoint or `NewClient` when tests need a mock server or a custom gateway.
