...
Install it with `go get github.com/gopact-ai/gopact-ext/models/openai@v0.5.18`. API paths are selected by `WithChatCompletionsAPI` or `WithResponsesAPI`; application code should pass a base URL, not concatenate endpoint paths.
