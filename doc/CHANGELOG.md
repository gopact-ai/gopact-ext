...
This changelog records user-visible changes for `gopact-ext`. Each extension is released as an independent Go submodule tag, for example `models/openai/v0.5.21`.
...
- Update extension modules to `gopact` core `v0.0.42`.
- Publish current extension tags on core `v0.0.42`: `agents/agentnode/v0.1.1`, `agents/agenttool/v0.1.20`, `agents/planexec/v0.2.21`, `agents/react/v0.2.19`, `agents/supervisor/v0.1.7`, `devagent/filesnapshot/v0.1.18`, `devagent/gitdiff/v0.1.18`, `models/openai/v0.5.21`, `models/ark/v0.2.19`, and `models/agnes/v0.1.22`.
