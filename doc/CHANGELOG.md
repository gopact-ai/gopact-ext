...
This changelog records user-visible changes for `gopact-ext`. Each extension is released as an independent Go submodule tag, for example `models/openai/v0.5.17`.
...
- Update extension modules to `gopact` core `v0.0.37`.
- Publish current extension tags on `gopact` core `v0.0.37`: `agents/agenttool/v0.1.16`, `agents/planexec/v0.2.17`, `agents/react/v0.2.15`, `agents/supervisor/v0.1.3`, `devagent/filesnapshot/v0.1.14`, `devagent/gitdiff/v0.1.14`, `models/openai/v0.5.17`, `models/ark/v0.2.15`, and `models/agnes/v0.1.18`.
