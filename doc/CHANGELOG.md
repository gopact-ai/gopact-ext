...
This changelog records user-visible changes for `gopact-ext`. Each extension is released as an independent Go submodule tag, for example `models/openai/v0.5.20`.
...
- Update extension modules to `gopact` core `v0.0.41`.
- Publish current extension tags on core `v0.0.41`: `agents/agentnode/v0.1.0`, `agents/agenttool/v0.1.19`, `agents/planexec/v0.2.20`, `agents/react/v0.2.18`, `agents/supervisor/v0.1.6`, `devagent/filesnapshot/v0.1.17`, `devagent/gitdiff/v0.1.17`, `models/openai/v0.5.20`, `models/ark/v0.2.18`, and `models/agnes/v0.1.21`.
