...
This changelog records user-visible changes for `gopact-ext`. Each extension is released as an independent Go submodule tag, for example `models/openai/v0.5.22`.
...
- Update extension modules to `gopact` core `v0.0.43`.
- Publish current extension tags on core `v0.0.43`: `agents/agentnode/v0.1.2`, `agents/agenttool/v0.1.21`, `agents/planexec/v0.2.22`, `agents/react/v0.2.20`, `agents/supervisor/v0.1.8`, `devagent/filesnapshot/v0.1.19`, `devagent/gitdiff/v0.1.19`, `models/openai/v0.5.22`, `models/ark/v0.2.20`, and `models/agnes/v0.1.23`.
