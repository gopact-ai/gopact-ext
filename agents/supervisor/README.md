...
Install it with `go get github.com/gopact-ai/gopact-ext/agents/supervisor@v0.1.10` and run `(cd agents/supervisor && go test -count=1 ./...)` before changing behavior.
