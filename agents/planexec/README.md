...
Install it with `go get github.com/gopact-ai/gopact-ext/agents/planexec@v0.2.17`. Use `NewModelAgent` for model-backed planning/execution or `New` when you want to provide custom `Planner`, `Executor`, and `Replanner` implementations.
